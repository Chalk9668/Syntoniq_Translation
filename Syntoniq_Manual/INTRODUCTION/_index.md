...
# コンポーネント
Syntoniqというのは主に次の二つにより成ります。
* **音楽を創る言語とコンパイラ**
  * プログラミング言語のように、音楽を正確かつ適切に、音価・音高・抑揚を記述し、生成します。生成した音楽はMIDIか[Csound](https://csound.com)形式になり、お好みのDAWなどに取り込めます
* **Syntoniq Keyboardによる微分音音楽用キーボードの使用**
  * 多少にはなりますが、任意のキーボード配列と調律、組み合わせにより、ありとあらゆる鍵盤を可能にします

# 詳細な特徴
**Syntoniqでは次のような事ができます。**
